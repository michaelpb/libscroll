// TODO: make a TinyTiny2, safe, asynchronous version of this library, that
// compiles to a node hierarchy, and "emits" tokens instead of concatenates, as
// such:
//
// Template tags ({% %} tags) have a compile step, and return a function that
// will perform the necessary thing (e.g. something like {"==": function (a, b)
// { return a === b; }}[op]; for `if')
// Filter tags will be mostly unchanged
//
// Also, template tags will be handed a few handy parsing functions, during
// compilation step, so they choose to parse to "endif", exactly like django.
// The only requirement is they return a Node: function (context, emit, done)
//
// And thus the TinyTiny Template is simply a root Node.
//
// This is necessary because:
// 1. keep Tag templates sandboxed (most important)
// 2. allow fully async streaming to a file, or over network
